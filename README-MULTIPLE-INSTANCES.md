...
* [Values.yaml](ValuesReplicator.yaml) para 3 instancias

Usa este fichero:

* [ValuesReplicator.yaml](ValuesReplicator.yaml)
...
Usa `db2-mysql-primary` para escritura.

Usa `db2-mysql-secondary` para lecturas distribuidas entre las réplicas.
